...
import 'package:art_gallery/items/museum_hall_items/maquiagem_artistica.dart';
...
class MuseumRoom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BonfireTiledWidget(
      ...
      player: CharacterJulia(Vector2(700, 1000)),
      progress: Container(
        color: Colors.black,
        child: Center(
          child: SizedBox(
